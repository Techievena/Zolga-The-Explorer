...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'Web GL.data';
    var REMOTE_PACKAGE_BASE = 'Web GL.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 4975410;
      var PACKAGE_UUID = '5098b8b9-ba56-4cfa-b34d-febfe2cd6a3a';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 2072962, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(2072962, 2072983, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(2072983, 2073006, 0, 0).open('GET', '/PlayerConnectionConfigFile');
    new DataRequest(2073006, 2073229, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(2073229, 3466357, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(3466357, 4947785, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(4947785, 4975410, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_Web GL.data');

    };
    Module['addRunDependency']('datafile_Web GL.data');
